...
import { editProduct } from '@/services/api/endpoints/edit-product'
...
import { convertPriceFloatToCents } from '@/utils/convert-price-float-to-cents'
...
export default function ConfirmationStep() {
  ...
  const editProductMutation = useMutation({
    mutationKey: ['editProduct', adsData.id],
    mutationFn: editProduct,
    onSuccess: () => {
      const imagesForm = new FormData()

      imagesForm.append('product_id', adsData.id)
  ...
  const addProductsImageMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast.show({
        type: 'success',
        text1: 'Produto editado com sucesso!',
      })
  ...
  function handleCreateProduct() {
    ...
    editProductMutation.mutate({
      data: {
        ...adsData,
        price: convertPriceFloatToCents(adsData.price),
      },
    })
  }
